...
<template>
  ...
  >
    ...
    <div class="relative">
            ...
            <CardContent class="p-5">
              <div class="hero-stagger" style="--i: 0">
                <div class="flex items-center gap-2.5 mb-5">
                  <div
                    class="w-8 h-8 rounded-xl bg-foreground/10 flex items-center justify-center shrink-0"
                  >
                    <Icon
              ...
              <div class="hero-stagger" style="--i: 2">
                <p class="text-sm text-muted-foreground leading-relaxed mb-10">
                  Connect with driven students in HCM City over Coursework,
                  game, coding, anything.
                </p>
              </div>
              ...
              <div class="hero-stagger" style="--i: 3">
                ...
                <div v-else class="space-y-3">
                  ...
                  <NuxtLink to="/profile">
                    <Button class="w-full h-10 font-semibold"
      ...
      >
        <p
          class="text-xs font-bold uppercase tracking-[0.3em] text-muted-foreground mb-6"
        >
          <Icon
            name="streamline-pixel:food-drink-desert-cake"
            size="18"
            class="inline mr-1.5 align-middle"
          />
          BECAUSE WE BELIEVE
        </p>
        <h2
          class="text-5xl md:text-7xl font-black leading-none tracking-tight mb-8"
        >
          The friends you make<br />
          <span class="text-accent">should feel intentional.</span>
        </h2>
        <p
          class="text-muted-foreground text-sm leading-relaxed max-w-sm mx-auto mb-10"
        >
          We connect like-minded students ready to grow together — over books,
          code, coffee, and everything in between.
        </p>
        <Button
          size="lg"
          class="h-11 px-8 font-semibold"
          @click="loginWithGoogle"
        >
          <Icon name="ri:sparkling-2-fill" size="15" />
          Connect today
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div class="h-56 relative overflow-hidden">
              ...
              />
              <div
                class="absolute inset-0 bg-linear-to-t from-card via-card/30 to-transparent"
              />
            </div>
            <CardContent class="p-6 -mt-2">
              <h3 class="text-xl font-extrabold mb-2">
                Find your <span class="text-accent">Studydate</span>
              </h3>
            ...
            <CardContent class="p-6 -mt-2">
              <h3 class="text-xl font-extrabold mb-2">
                ...
                <span class="text-muted-foreground text-sm font-normal">
                  (Builder Friend Forever)</span
                >
              </h3>
              <p class="text-sm text-muted-foreground leading-relaxed mb-5">
                New to HCM City? Connect with driven builders who make things
                happen.
              </p>
              <div class="flex flex-wrap gap-2">
                <button
                ...
                <button
                  ...
                  @click="loginWithGoogle"
                >
                  <Icon name="famicons:football-sharp" size="11" />Football
                  Friday
                </button>
              </div>
            </CardContent>
      ...
      >
        <div>
          <p
            class="text-xs font-bold uppercase tracking-[0.25em] text-muted-foreground mb-3 flex items-center"
          >
            <Icon
              name="pixel:angellist"
              size="18"
          ...
          <Card class="relative w-full max-w-xs p-0">
            <CardContent class="p-8">
              ...
              <p class="text-sm text-muted-foreground leading-relaxed mb-4">
                We will shoot you emails about features, meetups here in Saigon.
              </p>
      ...
      <footer class="pb-10 px-4">
        <div class="max-w-3xl mx-auto">
          <div
            class="h-px bg-linear-to-r from-transparent via-border to-transparent mb-8"
          />
          <div
          ...
          >
            <div class="flex items-center gap-2">
              <div
                class="w-5 h-5 rounded-lg bg-foreground/10 flex items-center justify-center"
              >
                <Icon
                  name="ri:sparkling-2-fill"
                  class="text-foreground"
