      ...
      <div class="flex-1 overflow-y-auto px-6 pb-8 space-y-6">
        ...
        >
          ...
          <div v-if="profile.bio" class="space-y-1">
            ...
            >
            <p
              class="text-sm font-medium leading-relaxed text-muted-foreground"
            >
              {{ profile.bio }}
            </p>
          </div>
        ...
        <div class="grid grid-cols-2 gap-3">
          <div
            class="p-4 rounded-2xl bg-accent/10 border border-accent/20 text-center"
          >
          ...
          <div
            class="p-4 rounded-2xl bg-cafe-matcha/10 border border-cafe-matcha/20 text-center"
          >
